...
import { ConfigurationCollection, ConfigurationEntry } from '../models';
...
export class ConfigurationService {
  ...
  private static createConfigEntry(configEntry: any): ConfigurationEntry {
    ...
    const result = new ConfigurationEntry(elementName, sequence, emptyLineBetweenElements);

    return result;
  }

  private static createConfigEntries(entriesFromConfig: any[] | undefined): ConfigurationCollection {
    const allFileSortings = new Array<ConfigurationEntry>();
